...
void main() => runApp(const CalculatorPakage());

class CalculatorPakage extends StatelessWidget {
  const CalculatorPakage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Android Calculator'),
        ),
        body: const Padding(
